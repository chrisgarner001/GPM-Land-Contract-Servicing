...
import { updateDriveFolderLink, type UpdateDriveFolderState } from "../actions";
...
export default function AttachmentsSection({
  ...
  const action = updateDriveFolderLink.bind(null, contractId);
  ...
  return (
    <div className="rounded-lg border border-slate-200 shadow-sm p-4">
      <h3 className="mb-3 text-xs font-semibold uppercase tracking-wide text-slate-400">Attachments</h3>
