...
export default async function OnboardingManualPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-8">
      ...
      <p className="mb-6 text-sm text-slate-500">Walk through Borrower, Property, and Land Contract terms to add a new contract.</p>

      <NewContractWizard suggestedContractNumber={suggestedContractNumber} />
    </main>
  );
}
